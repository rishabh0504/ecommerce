...
class Signup extends Component {
  ...
  validateEmail = email => {
    ...
    regexForEmail.test(email) === false ? this.setState({ emailError: "Invalid Email id." }) : this.setState({ emailError: "" });
  };

  validatePassword = () => {
    this.state.password === "" ? this.setState({ passwordError: "Invalid password."}) : this.setState({ passwordError: "" });
    this.state.confirmPassword === "" ? this.setState({ confirmPasswordError: "Invalid password." }) : this.setState({ confirmPasswordError: "" });
  ...
  validateMobileNo = mobileNo =>{
    ...
    regexFormobileNo.test(mobileNo) === false ? this.setState({ mobileNoError: "Invalid mobile no." }) : this.setState({ mobileNoError: "" });
  }
  inputDetails = () => {
